...
const (
	...
	UserAPI_RegisterTelegramUser_FullMethodName = "/proto.UserAPI/RegisterTelegramUser"
	UserAPI_VerifyToken_FullMethodName          = "/proto.UserAPI/VerifyToken"
)
...
func (c *userAPIClient) RegisterTelegramUser(ctx context.Context, in *RegisterTelegramUserRequest, opts ...grpc.CallOption) (*RegisterTelegramUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterTelegramUserResponse)
	err := c.cc.Invoke(ctx, UserAPI_RegisterTelegramUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userAPIClient) VerifyToken(ctx context.Context, in *VerifyTokenRequest, opts ...grpc.CallOption) (*VerifyTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VerifyTokenResponse)
	err := c.cc.Invoke(ctx, UserAPI_VerifyToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserAPIServer) RegisterTelegramUser(context.Context, *RegisterTelegramUserRequest) (*RegisterTelegramUserResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterTelegramUser not implemented")
}
func (UnimplementedUserAPIServer) VerifyToken(context.Context, *VerifyTokenRequest) (*VerifyTokenResponse, error) {
...
func _UserAPI_RegisterTelegramUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterTelegramUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserAPIServer).RegisterTelegramUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserAPI_RegisterTelegramUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserAPIServer).RegisterTelegramUser(ctx, req.(*RegisterTelegramUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _UserAPI_VerifyToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserAPIServer).VerifyToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserAPI_VerifyToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserAPIServer).VerifyToken(ctx, req.(*VerifyTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserAPI_RegisterTelegramUser_Handler,
		},
		{
			MethodName: "VerifyToken",
			Handler:    _UserAPI_VerifyToken_Handler,
		},
	},
